...
public class BigLInvertedPiece extends Piece {
     ...
     */
    public BigLInvertedPiece(Game game) {
        this.game = game;

        /*        squares = new Square[]{
        new Square(Game.MAX_X / 2, Game.SQUARE_SIDE, Color.BLUE, game),
        new Square(Game.MAX_X / 2, 0, Color.BLUE, game),
        new Square(Game.MAX_X / 2, 2 * Game.SQUARE_SIDE, Color.BLUE, game),
        new Square(Game.MAX_X / 2, 3 * Game.SQUARE_SIDE, Color.BLUE, game),
        new Square(Game.MAX_X / 2 - Game.SQUARE_SIDE, 3 * Game.SQUARE_SIDE, Color.BLUE, game)
        };*/
    ...
    public boolean rotate() {
        ...
        if (game.isValidPosition(squares[4].getX() + 3 * Game.SQUARE_SIDE, squares[4].getY() - Game.SQUARE_SIDE)) {
        ...
        if (game.isValidPosition(squares[4].getX() - Game.SQUARE_SIDE, squares[4].getY() - 2 * Game.SQUARE_SIDE)) {
        squares[1].setX(squares[1].getX() + Game.SQUARE_SIDE);
        squares[1].setY(squares[1].getY() - Game.SQUARE_SIDE);
