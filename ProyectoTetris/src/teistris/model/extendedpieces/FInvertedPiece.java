...
public class FInvertedPiece extends Piece {
     ...
     */
    public FInvertedPiece(Game game) {
        this.game = game;
        ...
        squares = new Square[]{
            ...
            Color.BLUE, game, Game.SQUARE_SIDE, Game.SQUARE_SIDE * 4),
            new Square(Game.MAX_X / 2 + Game.SQUARE_SIDE, Game.SQUARE_SIDE,
            Color.BLUE, game, Game.SQUARE_SIDE * 3, Game.SQUARE_SIDE * 3)
        };
        position = 0;
